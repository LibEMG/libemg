...
if __name__ == "__main__" :
    ...
    preds, prob = rejection_classifier.run(data_set["testing_features"], data_set["testing_labels"])
    rejection_classifier.visualize(data_set["testing_labels"], preds, prob)
    out_metrics = om.extract_offline_metrics(metrics, data_set['testing_labels'], preds, 2)
    ...
    preds, prob = mv_classifier.run(data_set["testing_features"], data_set["testing_labels"])
    out_metrics = om.extract_offline_metrics(metrics, data_set['testing_labels'], preds, 2)
    ...
    preds, prob = classifier.run(data_set["testing_features"], data_set["testing_labels"])
