...
class OnlineEMGClassifier(OnlineStreamer):
    ...
    def __init__(self, 
        ...
        self.previous_prediction_probabilities = deque(maxlen=self.predictor.majority_vote)
        self.smi = smm_items
    ...
    def default_prediction_function(self, model_input: np.ndarray) -> Tuple[Any, Any]:
        ...
        self.previous_prediction_probabilities.append(probability)
    ...
    def default_postprocessing_function(self, raw: Any, model_input: np.ndarray, window: Dict[str, Any]):
        ...
        predictions = self.predictor._apply_post_processing(list(self.previous_predictions), list(self.previous_prediction_probabilities))
