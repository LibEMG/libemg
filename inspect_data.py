...
# classes_values = ["Hand_Close","Hand_Open","No_Motion","Pronation","Supination","Wrist_Extension","Wrist_Flexion"]
# reps_values    = ["0","1","2"]
# odh = libemg.data_handler.OfflineDataHandler()
# odh.get_data("data_classifier/",
#              filename_dic = {"classes":classes_values,
#                              "classes_regex": libemg.utils.make_regex("data/","_", values=classes_values),
#                              "reps": reps_values,
#                              "reps_regex": libemg.utils.make_regex("_",".csv", values=reps_values)})
